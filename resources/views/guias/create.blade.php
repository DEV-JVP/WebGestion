        ...
        <div class="card shadow-lg border-0 rounded-3">
            <div class="card-body p-4 p-md-5">
                ...
                <h1 class="h3 fw-bold text-dark mb-4 border-bottom border-danger pb-3 d-flex align-items-center">
                    <i class="bi bi-person-plus-fill fs-4 me-3 text-danger"></i>
                    Nuevo
                </h1>
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-12">
                            ...
                            <select
                                ...
                                <option value="Guia" {{ old('tipo_cargo') == 'Guia' ? 'selected' : '' }}>Guía</option>
                                <option value="Logistica" {{ old('tipo_cargo') == 'Logistica' ? 'selected' : '' }}>Logística</option>
                                <option value="Coordinacion" {{ old('tipo_cargo') == 'Coordinacion' ? 'selected' : '' }}>Coordinación</option>
                                <option value="Sonido" {{ old('tipo_cargo') == 'Sonido' ? 'selected' : '' }}>Sonido</option>
                            </select>
                            @error('tipo_cargo')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
