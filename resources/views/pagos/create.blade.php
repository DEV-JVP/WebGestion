        ...
        <div class="card shadow-lg border-0 rounded-3">
            <div class="card-body p-4 p-md-5">
                ...
                <h1 class="h3 fw-bold text-dark mb-4 border-bottom border-danger pb-3 d-flex align-items-center">
                    <i class="bi bi-plus-circle fs-4 me-3 text-danger"></i>
                    Agregar Pago para <span class="text-primary">{{ $confirmando->nombre }}</span>
                </h1>
                ...
                <form action="{{ route('pagos.store', $confirmando) }}" method="POST">
                    @csrf
